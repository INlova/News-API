$(document).ready(() => {
	...
	function getNewNews() {
		...
		let apiKey = "299724b477974817929291d2fcbe15d4";
		//sources can be added from the included links.txt
		let urls = [`${endPoint}?source=bloomberg&sortBy=latest&apiKey=${apiKey} `, `${endPoint}?source=business-insider&sortBy=latest&apiKey=${apiKey} `];
		let allResults = [];
